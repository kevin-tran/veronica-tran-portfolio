      ...
      <div className={styles.container}>
        <div>
          <section className={styles.headerContainer}>
            ...
            <div className={styles.contentContainer}>
              <p>
                <b>Nurturing digital communities</b>
              </p>
              <p>
                Online collective/publication. Mesh is a digital archive of
                community knowledge and a learning project. Created a series of
                illustrations for Mesh’s online publication and projects,
                including Memory Cards, Introduction essays, and an essay titled
                ‘Digital Diaspora: Exit and Movement’, written for issue one of
                Mesh Archive.
              </p>
            </div>
          </section>
...
export const query = graphql`
  query {
    ...
    thumbnailPrev: file(relativePath: { eq: "thumbnails/sonar-feature.gif" }) {
      publicURL
    }
    thumbnailNext: file(
