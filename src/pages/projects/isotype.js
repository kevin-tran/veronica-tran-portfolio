            ...
            <div className={styles.container}>
                <div>
                    <section className={styles.headerContainer}>
                        ...
                        <div className={styles.contentContainer}>
                            <p><b>Exhibiting form, balance, and perspective</b></p>
                            <p>Typeface created using 3D printing, and is a series of letters that can only be viewed from an isometric angle. Any other direction, and it will be skewed to the point of illegibility. It was an exploration of bringing a common illustrative trope I’ve seen into a real 3D space.</p>
                        </div>
                    </section>
                </div>
                ...
                <div className={styles.imageContainer}>
                  ...
                  <img src={data.galleryImage8.publicURL} className={styles.placeholder} alt='iso city gallery item 6' />
                </div>
...
query {
  ...
  thumbnailPrev: file(relativePath: { eq: "thumbnails/fab-city-feature.png" }) {
    childImageSharp {
  ...
  thumbnailNext: file(relativePath: { eq: "thumbnails/mesh-archive-feature.png" }) {
    childImageSharp {
        fluid(maxWidth: 300, quality: 100) {
          ...GatsbyImageSharpFluid_withWebp_noBase64
        }
