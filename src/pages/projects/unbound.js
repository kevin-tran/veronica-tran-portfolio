      ...
      <div className={styles.container}>
        <div>
          <section className={styles.headerContainer}>
            ...
            <div className={styles.contentContainer}>
              <p>
                <b>Deconstructing a classic novel </b>
              </p>
              <p>
                A reinterpretation of the Frankenstein novel, and accumulated
                set of experiments put together in a way that tells a parallel
                and gradual narrative to the novel. It aims to look at the
                Frankenstein text in conjunction with typographic experiments
                via layering the text, pulling apart legibility, and utilizing
                vibrant colours, creating a monster in the process.
              </p>
            </div>
          </section>
        </div>
